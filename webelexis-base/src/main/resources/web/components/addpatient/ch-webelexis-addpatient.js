...
define(['knockout', 'app/eb', 'app/config', 'text!tmpl/ch-webelexis-addpatient.html', 'app/datetools', 'R', 'jquery', 'validate'], function(ko, bus, cfg, html, dt, i18, $) {
  ...
  R.registerLocale("de", {
    ...
    existing_pat: " Wenn Sie schon Patient/in bei uns sind, und jetzt nur ein Konto für die Online-Terminvergabe erstellen möchten, wählen Sie bitte diese Option.",
    new_pat: " Wenn Sie noch nie bei uns waren, wählen Sie bitte diese Option und füllen Sie alle Felder aus.",
    goto_login: ' Wenn Sie bereits ein Konto haben, können Sie direkt zum Login gehen.',
