...
import ch.rgw.tools.HuffmanTree.Node;
...
public class Huff {
   ...
   * @param source the source to compress. If tree is null, the Tree will be computed from the source
   *               first and its frequency table is included in the output.
   * @return The huffman compressed source
   */
  public static byte[] encode(HuffmanTree tree, byte[] source) throws Exception {
   ...
   * @param source A huffman compressed array as returned by encode(). If tree is null, the frequency
   *               count is expected to be included to the source.
   * @return the decoded data or null on error.
   */
  public static byte[] decode(HuffmanTree tree, byte[] source) throws Exception {
   ...
   */
  public static byte[] encodeString(HuffmanTree tree, String i) throws Exception {
    byte[] b = i.getBytes();
   ...
   */
  public static String decodeString(HuffmanTree tree, byte[] in) throws Exception {
