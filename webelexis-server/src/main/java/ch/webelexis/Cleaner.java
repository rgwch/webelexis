...
public class Cleaner {
  ...
  public JsonArray getArray(String name, JsonArray defaultValue) {
    JsonArray ret = jo.body().getJsonArray(name);
   ...
   *
   * @param result an arbitrary object. By convention, a field "status" should exist
  ...
  public void replyError() {
    jo.reply(new JsonObject().put("status", "error"));
  }
  ...
  public void replyError(String msg) {
    JsonObject result = new JsonObject().put("status", "error").put("message", msg);
    jo.reply(result);
  }
   ...
   */
  public void replyOk() {
    jo.reply(new JsonObject().put("status", "ok"));
  }
  ...
  public void replyOk(String msg) {
    JsonObject result = new JsonObject().put("status", "ok").put("message", msg);
    jo.reply(result);
  }
  ...
  public void replyStatus(String msg) {
    jo.reply(new JsonObject().put("status", msg));
  }
