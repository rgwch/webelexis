...
public class StringTool {
  ...
  @SuppressWarnings("unchecked")
  public static String flattenStrings(final Hashtable h) throws Exception {
    return flattenStrings(h, null);
  }

  public static String flattenStrings(final Hashtable<Object, Object> h, final flattenFilter fil) throws Exception {
    if (h == null) {
      return null;
    }
   ...
   */
  public static byte[] pack(final Collection<String> strings) throws Exception {
   ...
   */
  public static byte[] pack(final String[] strings) throws Exception {
    String res = join(strings, "\n");
    return CompEx.Compress(res, CompEx.ZIP);
  }
  ...
  @SuppressWarnings("unchecked")
  @Deprecated
  public static byte[] flatten(final Hashtable hash, final int compressMode, final Object ExtInfo) throws Exception {
  ...
  static private Object StringToObject(final String s) throws IOException, ClassNotFoundException {
  ...
  @SuppressWarnings("unchecked")
  public static Hashtable foldStrings(final String s) throws IOException, ClassNotFoundException {
   ...
   */
  public static String enPrintable(final byte[] src) throws UnsupportedEncodingException {
    return enPrintable(src, 70); // compatibility
  }

  static public String enPrintable(final byte[] src, final int offset) throws UnsupportedEncodingException {
   ...
   */
  public static byte[] dePrintable(final String src) throws UnsupportedEncodingException {
    return dePrintable(src, 70); // compatibility
  }

  static public byte[] dePrintable(final String src, final int offset) throws UnsupportedEncodingException {
    byte[] input = null;
   ...
   */
  public static String enPrintableStrict(byte[] src) throws UnsupportedEncodingException {
    if (src == null) {
      return null;
    }
   ...
   *
   * @param src a String previously created by enPrintableStrict
   * @return a byte array with the original data or null on errors
   */
  public static byte[] dePrintableStrict(String src) throws UnsupportedEncodingException {
    byte[] input = null;
    input = src.getBytes(default_charset);
