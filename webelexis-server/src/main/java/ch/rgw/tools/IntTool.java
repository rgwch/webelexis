...
public class IntTool {
   ...
   *
   * @param arr    Zielarray
   * @param offset Offset im Array, ab dem geschrieben werden soll
   ...
   *
   * @param arr    Das Quellarray
   * @param offset Offset innerhalb des Arrays, ab dem gelesen werden soll
