...
public class StringTool {
	...
	static String ObjectToString(final Object o) throws IOException {
	...
	static Object StringToObject(final String s) throws IOException,
	...
	public static String unique(final String salt) {
		...
		return new StringBuilder().append(start).append(Long.toHexString(t4))
				.append(Long.toHexString((long) Math.random() * 1000))
	...
	/**
	 * Gibt das Wort des Inhalts zurück das an oder unmittelbar vor der
	 * angegebenen Position ist
	 * 
	 * @return Das mit an dieser Stelle befindliche Wort des Strings,
	 *         <code>String.empty</code> falls kein Wort dort ist idt oder der
	 *         Index ausserhalb des Textbereichs ist
	 */
	...
	/**
	 * Parse a Double from a string but don't throw an Exception if not
	 * parseable. Return 0.0 instead.
	 * 
	 * @param string
	 *            a String containing probably a Double
	 * @return always a double. 0.0 if the origin was 0.0 or null or not a
	 *         Double
	 */
	 ...
	 * @param in
	 *            ein String
	 * @return derselbe String, aber alle möglicherweise kritische Zeichen durch
	 *         _ ersetzt.
	 */
	...
	/**
	 * convert a String from a source encoding to this platform's default
	 * encoding
	 * 
	 * @param src
	 *            the source string
	 ...
	 * @return die Zahl ohne prüfziffer oder null, wenn die Prüfziffer falsch
	 *         war.
	 */
	...
	private static final char[] salties = { 'q', 'w', 'e', 'r', 't', 'z', 'u',
			'o', 'i', 'p', 'a', 's', 'd', 'f', 'g', 'h', 'j', 'k', 'l', 'y',
			'x', 'c', 'v', 'b', 'n', 'm', 'Q', 'A', 'Y', 'W', 'E', 'D', 'C',
			'R', 'F', 'V', 'T', 'G', 'B', 'Z', 'H', 'N', 'U', 'J', 'M', 'I',
			'K', 'O', 'L', 'P' };
}