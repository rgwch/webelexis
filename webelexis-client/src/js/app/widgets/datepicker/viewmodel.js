...
define(['knockout', 'durandal/system', 'durandal/composition', 'i18n', 'jquery-ui'], function (ko, system, composition, R) {

  R.loadNamespace("datepicker", function () {
    system.log("namespace datepicker loaded")
  })
